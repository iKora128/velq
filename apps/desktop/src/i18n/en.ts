...
export const en = {
  ...
  "settings.editor.preview": "Preview",
  ...
  "action.viewPreview": "View: Preview (read-only)",
  ...
  "agent.stateWriting": "Writing…",
  "agent.stateWaiting": "Waiting for your OK",
  "agent.stateReady": "Ready",
  "agent.mode": "Permissions",
  "agent.pickAssistant": "Choose assistant",
  "agent.pickModel": "Choose model",
  "agent.pickEffort": "Thinking effort",
  "agent.pickMode": "Editing permissions",
  "agent.tokensTitle": "Context used: {used} of {max} tokens",
  "agent.diffMore": "+{count} more lines",
