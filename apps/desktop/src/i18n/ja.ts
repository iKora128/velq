...
export const ja: Dict = {
  ...
  "action.viewPreview": "表示: プレビュー（読み取り専用）",
  ...
  "agent.stateThinking": "考え中…",
  "agent.stateWriting": "応答中…",
  "agent.stateWaiting": "確認待ち",
  "agent.stateReady": "待機中",
  "agent.mode": "権限",
  "agent.pickAssistant": "アシスタントを選ぶ",
  "agent.pickModel": "モデルを選ぶ",
  "agent.pickEffort": "思考の深さ",
  "agent.pickMode": "編集の許可",
  "agent.tokensTitle": "コンテキスト使用量 {used} / {max} トークン",
  "agent.diffMore": "他 {count} 行",
